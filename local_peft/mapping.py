...
from .peft_model import (
    ...
    PeftModelForMultiTaskClassification,
...
MODEL_TYPE_TO_PEFT_MODEL_MAPPING = {
    ...
    "SEQ_MT_CLS": PeftModelForMultiTaskClassification,
...
def get_peft_model(model, peft_config, config):
    """
    ...
    if peft_config.task_type == "SEQ_MT_CLS":
        return MODEL_TYPE_TO_PEFT_MODEL_MAPPING[peft_config.task_type](model, peft_config, config)
    else:
